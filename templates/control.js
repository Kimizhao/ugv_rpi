...
var laser_off, laser_on, light_off, light_on
var armZ, armR, armE;
...
fetch('/config')
    ...
    .then(yamlText => {
        try {
            ...
            light_off = yamlObject.code.light_off;
            light_on = yamlObject.code.light_on;
            laser_off = yamlObject.code.laser_off;
            laser_on = yamlObject.code.laser_on;
